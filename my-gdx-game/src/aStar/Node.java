...
public class Node implements Comparable<Node> {
	...
	Node (int x, int y, boolean visited, int distanceFromStart, boolean isObstical, boolean isStart, boolean isGoal,int id) {
		neighborList = new ArrayList<Node>();
		this.x = x;
		this.y = y;
...
//	}
	...
	public int compareTo(Node otherNode) {//funcion de comparacion
